...
class Color extends Field {
	...
	public $type = 'phys-color';

	protected $control_class = '\PhysCode\Customizer\Control\Color';
	...
	public function output_control_classnames( $control_classes ) {
		$control_classes['phys-color'] = '\PhysCode\Customizer\CSS\Color';
