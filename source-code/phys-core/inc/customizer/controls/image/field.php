...
class Image extends Field {
	...
	public $type = 'phys-image';

	protected $control_class = '\PhysCode\Customizer\Control\Image';

	protected $control_has_js_template = true;

	protected function init( $args ) {
		add_filter( 'phys_customizer_output_item_args', array( $this, 'output_item_args' ), 10, 4 );
	...
	public function output_control_classnames( $classnames ) {
		$classnames['phys-image'] = '\PhysCode\Customizer\CSS\Image';
