...
class Typography extends Field {
	...
	public function enqueue_control_scripts() {
		wp_localize_script( 'phys-customizer-control', 'physTypographyControls', self::$typography_controls );
		...
		if ( ! self::$fonts_var_added ) {
			...
			$google = new \PhysCode\Customizer\Utils\GoogleFonts();

			wp_localize_script( 'phys-customizer-control', 'physGoogleFonts', $google->get_array() );
			wp_add_inline_script( 'phys-customizer-control', 'var physCustomVariants = {};', 'before' );
		...
		$custom_variant_value = wp_json_encode( \PhysCode\Customizer\Utils\Helper::prepare_php_array_for_js( $variants ) );

		wp_add_inline_script(
			'phys-customizer-control',
			'physCustomVariants["' . $custom_variant_key . '"] = ' . $custom_variant_value . ';',
			$variants
		);
	}
	...
	public static function get_standard_fonts() {
		...
		return apply_filters( 'phys_customizer_fonts_standard_fonts', $standard );
	}

	private function add_sub_fields( $args ) {
		$args['phys_config'] = isset( $args['phys_config'] ) ? $args['phys_config'] : 'global';
		...
		$args['wrapper_attrs']  = array(
			'data-phys-parent-control-type' => 'phys-typography',
		...
		if ( isset( $args['default']['font-family'] ) ) {
			new \PhysCode\Customizer\Field\Select(
				wp_parse_args(
					array(
						'label'       => 'Font Family',
						'description' => '',
						...
						'wrapper_attrs' => wp_parse_args(
							array(
								'phys-typography-subcontrol-type' => 'font-family',
							),
							$args['wrapper_attrs']
						),
						'choices'     => array(),
			...
			new \PhysCode\Customizer\Field\Select(
				wp_parse_args(
					array(
						...
						'default'     => apply_filters( 'phys_customizer_typography_family_variants_default', $font_variant, $args['id'] ),
						...
						'wrapper_attrs' => wp_parse_args(
							array(
								'phys-typography-subcontrol-type' => 'font-family-variant',
							),
							$args['wrapper_attrs']
						),
						'multiple'    => true,
			...
			new \PhysCode\Customizer\Field\Select(
				wp_parse_args(
					array(
						...
						'wrapper_attrs' => wp_parse_args(
							array(
								'phys-typography-subcontrol-type' => 'font-variant',
								'class' => $args['wrapper_attrs']['class'] . ' phys-group-item phys-w50',
							),
							$args['wrapper_attrs']
						),
						'choices'       => array(),
			...
			new \PhysCode\Customizer\Field\Dimension(
				wp_parse_args(
					array(
						...
						'wrapper_attrs' => wp_parse_args(
							array(
								'data-phys-typography-css-prop' => 'font-size',
								'phys-typography-subcontrol-type' => 'font-size',
								'class' => $args['wrapper_attrs']['class'] . ' phys-group-item phys-w50',
							),
							$args['wrapper_attrs']
						),
		...
		if ( isset( $defaults['color'] ) ) {
			new \PhysCode\Customizer\Field\Color(
				wp_parse_args(
					array(
						'label'         => 'Font Color',
						'description'   => '',
						...
						'wrapper_attrs' => wp_parse_args(
							array(
								'data-phys-typography-css-prop' => 'color',
								'phys-typography-subcontrol-type' => 'color',
								'class' => $args['wrapper_attrs']['class'] . ' phys-group-item phys-w50',
							),
							$args['wrapper_attrs']
						),
			...
			new \PhysCode\Customizer\Field\Select(
				wp_parse_args(
					array(
						...
						'wrapper_attrs' => wp_parse_args(
							array(
								'data-phys-typography-css-prop' => 'text-align',
								'phys-typography-subcontrol-type' => 'text-align',
								'class' => $args['wrapper_attrs']['class'] . ' phys-group-item phys-w50',
							),
							$args['wrapper_attrs']
						),
			...
			new \PhysCode\Customizer\Field\Select(
				wp_parse_args(
					array(
						...
						'wrapper_attrs' => wp_parse_args(
							array(
								'data-phys-typography-css-prop' => 'text-transform',
								'phys-typography-subcontrol-type' => 'text-transform',
								'class' => $args['wrapper_attrs']['class'] . ' phys-group-item phys-w50',
							),
							$args['wrapper_attrs']
						),
			...
			new \PhysCode\Customizer\Field\Select(
				wp_parse_args(
					array(
						...
						'wrapper_attrs' => wp_parse_args(
							array(
								'data-phys-typography-css-prop' => 'text-decoration',
								'phys-typography-subcontrol-type' => 'text-decoration',
								'class' => $args['wrapper_attrs']['class'] . ' phys-group-item phys-w50',
							),
							$args['wrapper_attrs']
						),
			...
			new \PhysCode\Customizer\Field\Dimension(
				wp_parse_args(
					array(
						...
						'wrapper_attrs' => wp_parse_args(
							array(
								'data-phys-typography-css-prop' => 'line-height',
								'phys-typography-subcontrol-type' => 'line-height',
								'class' => $args['wrapper_attrs']['class'] . ' phys-group-item phys-w50',
							),
							$args['wrapper_attrs']
						),
			...
			new \PhysCode\Customizer\Field\Dimension(
				wp_parse_args(
					array(
						...
						'wrapper_attrs' => wp_parse_args(
							array(
								'data-phys-typography-css-prop' => 'letter-spacing',
								'phys-typography-subcontrol-type' => 'letter-spacing',
								'class' => $args['wrapper_attrs']['class'] . ' phys-group-item phys-w50',
							),
							$args['wrapper_attrs']
						),
			...
			new \PhysCode\Customizer\Field\Dimension(
				wp_parse_args(
					array(
						...
						'wrapper_attrs' => wp_parse_args(
							array(
								'data-phys-typography-css-prop' => 'margin-top',
								'phys-typography-subcontrol-type' => 'margin-top',
								'class' => $args['wrapper_attrs']['class'] . ' phys-group-item phys-w50',
							),
							$args['wrapper_attrs']
						),
			...
			new \PhysCode\Customizer\Field\Dimension(
				wp_parse_args(
					array(
						...
						'wrapper_attrs' => wp_parse_args(
							array(
								'data-phys-typography-css-prop' => 'margin-bottom',
								'phys-typography-subcontrol-type' => 'margin-bottom',
								'class' => $args['wrapper_attrs']['class'] . ' phys-group-item phys-w50',
							),
							$args['wrapper_attrs']
						),
		...
		new \PhysCode\Customizer\Field\Custom(
			wp_parse_args(
				array(
					'label'       => '',
					'description' => '',
	...
	public static function sanitize( $value ) {
		...
		foreach ( $value as $key => $val ) {
			switch ( $key ) {
				...
				case 'color':
					$value['color'] = '' === $value['color'] ? '' : \PhysCode\Customizer\Field\Color::sanitize( $value['color'] );
					break;
	...
	private function get_font_family_choices() {
		...
		$choices['default'] = array(
			'Defaults',
			apply_filters(
				'phys_customizer_fonts_default_fonts',
				array(
					'' => 'Default',
				)
			),
