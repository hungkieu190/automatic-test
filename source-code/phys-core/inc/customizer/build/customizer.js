...
const DynamicControl = wp.customize.Control.extend({
  initialize: function (id, options) {
    ...
    (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_0__.doAction)('phys.dynamicControl.init.after', id, control, args);
  },
  ...
  ready: function () {
    ...
    control.deferred.embedded.done(function () {
      control.initPhysControl();
      (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_0__.doAction)('phys.dynamicControl.ready.deferred.embedded.done', control);
    });
    (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_0__.doAction)('phys.dynamicControl.ready.after', control);
  },
  embed: function () {
    var control = this,
    ...
    wp.customize.section(sectionId, function (section) {
      if ('phys-expanded' === section.params.type || section.expanded() || wp.customize.settings.autofocus.control === control.id) {
    ...
    (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_0__.doAction)('phys.dynamicControl.embed.after', control);
  },
  actuallyEmbed: function () {
    ...
    (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_0__.doAction)('phys.dynamicControl.actuallyEmbed.after', control);
  },
  focus: function (args) {
    var control = this;
    control.actuallyEmbed();
    wp.customize.Control.prototype.focus.call(control, args);
    (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_0__.doAction)('phys.dynamicControl.focus.after', control);
  },
  initPhysControl: function (control) {
    control = control || this;
    (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_0__.doAction)('phys.dynamicControl.initPhysControl', this); // Save the value
...
const ColorComponent = props => {
  ...
  let formClassName = useHueMode ? "phys-control-form use-hue-mode" : "phys-control-form";
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__.Dropdown, {
    ...
    contentClassName: "phys-color-component__popover",
    renderToggle: _ref => {
      let {
        isOpen,
        onToggle
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, choices.labelStyle === 'tooltip' ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
        ...
        className: "phys-control-cols"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "phys-control-left-col"
      }, controlLabel, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "customize-control-notifications-container",
        ref: props.setNotificationContainer
      })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "phys-control-right-col"
...
const ColorCircle = props => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "phys-trigger-circle-wrapper"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    type: "button",
    className: "phys-trigger-circle",
...
const ColorInput = props => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "phys-color-input-wrapper"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "phys-color-input-control"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "text",
    value: value,
    className: "phys-color-input",
    spellCheck: "false",
...
const ColorSwatches = _ref => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "phys-color-swatches"
  }, colors.map((clr, index) => {
    const color = clr && clr.color ? clr.color : clr;
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
      key: index.toString(),
      type: "button",
      className: "phys-color-swatch",
      "data-phys-color": color,
      style: {
...
__webpack_require__.r(__webpack_exports__);
const PhysDependencies = () => {
  let dependencyControls = {};

  const getSettingLink = controlID => {
    var control = document.querySelector('[data-phys-setting="' + controlID + '"]');
    var setting = controlID;

    if (control) {
      if (controlID !== control.dataset.physSettingLink) {
        setting = control.dataset.physSettingLink;
      }
    }
  ...
  Object.entries(window.physControlDependencies).forEach(_ref => {
    ...
    dependency.childrens.forEach(childrenSetting => {
      wp.customize(dependency.settingLink, function (setting) {
        const setupControl = control => {
          const isDisplayed = () => {
            return showPhysControl(wp.customize.control(childrenSetting));
          };
...
/* harmony default export */ __webpack_exports__["default"] = (PhysDependencies);
...
const SelectComponent = props => {
  ...
  const inputId = props.inputId ? props.inputId : "phys-react-select-input--" + props.customizerSetting.id;
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", null, props.label && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("label", {
    ...
    inputId: inputId,
    className: "phys-react-select-container",
    classNamePrefix: "phys-react-select",
    inputClassName: "phys-react-select-input",
...
const SliderComponent = props => {
  ...
  const fieldId = `phys-control-input-${customizerSetting.id}`;
  const value = "" !== props.value ? props.value : 0;
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "phys-control-form",
    tabIndex: "1"
    ...
    max: choices.max,
    step: choices.step,
    className: "phys-control-slider",
    onChange: handleChange
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "phys-control-right-col"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "phys-control-value",
    ref: valueRef
  }, value))));
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ PhysTooltips; }
/* harmony export */ });
function physTooltipAdd(control) {
  Object.entries(physCustomizerTooltips).forEach(function (_ref) {
    ...
    if (!target) return;
    target.classList.add('phys-tooltip-wrapper'); // Build the tooltip trigger.
...
function PhysTooltips() {
  ...
  jQuery('head').append(jQuery('<style class="phys-tooltip-inline-styles"></style>'));
  const $tooltipStyleEl = jQuery('.phys-tooltip-inline-styles');
      ...
      section.expanded.bind(function (expanded) {
        if (expanded) {
          if (section.contentContainer[0].scrollHeight > $sidebarOverlay.height()) {
            $tooltipStyleEl.html('.phys-tooltip-wrapper span.tooltip-content {min-width: 258px;}');
          } else {
...
function TypographyControl(id, value) {
  ...
  const isGoogle = value["font-family"] && physGoogleFonts.items[value["font-family"]];
  ...
  if (isGoogle) {
    let gFontVariants = physGoogleFonts.items[value["font-family"]].variants;
    gFontVariants.sort(sortVariants);
    physFontVariants.complete.forEach(function (variant) {
    ...
    if (physCustomVariants[customVariantKey][value["font-family"]]) {
      variants = physCustomVariants[customVariantKey][value["font-family"]];
    } else {
      variants = physFontVariants.standard;
    }
  ...
  (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_0__.addAction)("phys.dynamicControl.initPhysControl", "phys", function (controlInit) {
...
controlConstructor['phys-slider'] = _slider_control__WEBPACK_IMPORTED_MODULE_1__["default"];
controlConstructor['phys-color'] = _color_control__WEBPACK_IMPORTED_MODULE_2__["default"];
controlConstructor['phys-dimension'] = _dimension_control__WEBPACK_IMPORTED_MODULE_3__["default"];
controlConstructor['phys-radio'] = _base_control__WEBPACK_IMPORTED_MODULE_4__["default"].extend({});
controlConstructor['phys-radio-buttonset'] = _base_control__WEBPACK_IMPORTED_MODULE_4__["default"].extend({});
controlConstructor['phys-image'] = _base_control__WEBPACK_IMPORTED_MODULE_4__["default"].extend({
  initPhysControl: _image_control__WEBPACK_IMPORTED_MODULE_9__["default"]
});
controlConstructor['phys-switch'] = _base_control__WEBPACK_IMPORTED_MODULE_4__["default"].extend({
  initPhysControl: _switch_control__WEBPACK_IMPORTED_MODULE_10__["default"]
});
controlConstructor['phys-toggle'] = _base_control__WEBPACK_IMPORTED_MODULE_4__["default"].extend({
  initPhysControl: _switch_control__WEBPACK_IMPORTED_MODULE_10__["default"]
});
controlConstructor['phys-sortable'] = _sortable_control__WEBPACK_IMPORTED_MODULE_5__["default"];
controlConstructor['phys-select'] = _select_control__WEBPACK_IMPORTED_MODULE_6__["default"]; // TypographyControl.

jQuery(document).ready(function () {
  _.each(physTypographyControls, function (id) {
