...
abstract class Field {
	...
	public function __construct( $args ) {
		...
		do_action( 'phys_customizer_field_init', $this->args, $this );
		...
		add_filter( 'phys_customize_field_add_setting_args', array( $this, 'filter_setting_args' ), 10, 2 );
		add_filter( 'phys_customize_field_add_control_args', array( $this, 'filter_control_args' ), 10, 2 );
	}
	...
	public function add_setting( $customizer ) {
		...
		$args = apply_filters( 'phys_customize_field_add_setting_args', $args, $customizer );
	...
	public function add_control( $wp_customize ) {
		...
		$args = apply_filters( 'phys_customize_field_add_control_args', $this->args, $wp_customize );
