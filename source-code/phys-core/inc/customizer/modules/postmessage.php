...
class Postmessage {
	...
	public function __construct() {
		...
		add_action( 'phys_customize_field_add_setting_args', array( $this, 'field_add_setting_args' ) );
	}
	...
	public function postmessage_script() {
		...
		wp_localize_script( 'phys-customizer-control', 'physPostMessageFields', $data );
	}
}
