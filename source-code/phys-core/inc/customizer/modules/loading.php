...
class Loading {
	...
	public function add_loader_to_footer() {
		?>
		<div class="phys-customizer-loading-wrapper">
			<span class="phys-customizer-loading"></span>
		</div>
		<?php
	}
	...
	public function add_loader_styles_to_header() {
		...
		<style>
			...
			.phys-customizer-loading-wrapper {
				width: 100%;
				height: 100%;
				position: fixed;
				top: 0;
			...
			body.wp-customizer-unloading .phys-customizer-loading-wrapper {
				display: block;
				opacity: 1;
			}
			.phys-customizer-loading-wrapper .phys-customizer-loading {
				position: absolute;
				width: 60px;
				height: 60px;
				top: 50%;
