...
class Output {
			...
			foreach ( $output['pattern_replace'] as $search => $replace ) {
				...
				switch ( $option_type ) {
					...
					default:
						...
						if ( ! $replacement ) {
							$replacement = Values::get_value( $this->field['phys_config'], $replace );
						}
				}
	...
	protected function process_output( $output, $value ) {
		$output = apply_filters( 'phys_customizer_output_item_args', $output, $value, $this->output, $this->field );
	...
	protected function process_property_value( $property, $value ) {
		$properties = apply_filters(
			'phys_customizer_output_property_classnames',
			[
				'font-family'         => '\PhysCode\Customizer\Modules\CSS\Property\Fontfamily',
				'background-image'    => '\PhysCode\Customizer\Modules\CSS\Property\Backgroundimage',
				'background-position' => '\PhysCode\Customizer\Modules\CSS\Property\Backgroundposition',
			]
		);
