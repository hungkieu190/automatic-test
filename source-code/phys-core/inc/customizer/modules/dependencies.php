...
class Dependencies {
	...
	public function __construct() {
		...
		add_filter( 'phys_customize_field_add_control_args', array( $this, 'field_add_control_args' ) );
	}
	...
	public function field_dependencies_scripts() {
		wp_localize_script( 'phys-customizer-control', 'physControlDependencies', $this->dependencies );
	}
}
