		...
		<div class="list-plugins">
			...
			foreach ( $plugins as $index => $plugin ) :
				...
				if ( $plugin->get_icon() ) {
					...
					if ( in_array( $plugin->get_slug(), ['elementor','embedpress','learnpress'], true ) ) {
						$plugin_icon = 'https://ps.w.org/' . $plugin->get_slug() . '/assets/icon-128x128.gif';
					}
					if ( $plugin->get_slug() == 'learnpress-sepay-payment' ) { // lp sepay
						$plugin_icon = 'https://ps.w.org/' . $plugin->get_slug() . '/assets/icon-128x128.jpg';
					}
					$premium     = '0';
				...
				if ( $plugin->get_slug() == 'woocommerce' ) {
					$plugin_icon = 'https://ps.w.org/' . $plugin->get_slug() . '/assets/icon-128x128.png';
				}
