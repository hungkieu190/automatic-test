...
$link_review = Phys_Product_Registration::get_link_reviews();
?>
...
<div class="top">
	...
	$html_finish .= '<div class="row">
		<div class="col-md-6">
			<h3>Next Steps</h3>
			<ul>
				<li><a class="button button-secondary tc-button" href="https://www.facebook.com/PhysCode/" target="_blank" rel="noopener">Follow Facebook</a></li>
				<li><a class="button button-secondary tc-button" href="' . esc_url( Phys_Dashboard::get_link_main_dashboard() ) . '">Theme Dashboard</a></li>
			</ul>
		</div>
		<div class="col-md-6">
			<h3>More Resources</h3>
 			<ul>
				...
				<li class="blog"><a href="https://physcode.com/blog/" target="_blank" rel="noopener">Read our blog</a></li>
				<li class="rating"><a href="' . esc_url( $link_review ) . '" target="_blank" rel="noopener">Leave an Item Rating</a></li>
			</ul>
		</div>
	</div>';
	echo apply_filters( 'phys_core_html_finish_dashboard', $html_finish );
	?>
...
<div class="bottom">
	...
	<a href="<?php echo esc_url( get_home_url() ); ?>" target="_blank" class="button button-primary tc-button tc-run-step" rel="noopener">
		<?php esc_html_e( 'View Your Site', 'phys-core' ); ?>
	</a>
</div>
