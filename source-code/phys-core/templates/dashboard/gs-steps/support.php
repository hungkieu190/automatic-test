<div class="top">
	...
	$html_support = '<div class="caption">
        <p>This theme is quality checked by Envato and is maintained by PhysCode. It comes with 6 month support from the purchase date. There is an option for you extend this support period. If you
            wish to use this theme on another website, please purchase an additional license for your support benefits.</p>
    </div>
    <div>
        <div class="text-success">Item Support can be accessed from <a href="https://support.physcode.com/" target="_blank">PhysCode</a> and includes:</div>
        ...
        <ul class="tc-list">
             <li>Installation Services (this can be available if you contact our support team via <a href="http://physcode.com/forums/" target="_blank">our forum</a> )
            </li>
	...
	echo apply_filters( 'phys_core_html_help_support', $html_support );
	?>
...
<div class="bottom">
	...
	<button
		class="button button-primary tc-button tc-run-step"><?php esc_html_e( 'Agree and Continue', 'phys-core' ); ?></button>
</div>
