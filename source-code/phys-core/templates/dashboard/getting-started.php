<?php
$steps       = Phys_Getting_Started::get_steps();
...
<div class="phys-getting-started">
    <header>
            ...
            foreach ( $steps as $index => $step ) :
                ...
                <li>
                    <a class="step" data-position="<?php echo esc_attr( $index ); ?>" data-step="<?php echo esc_attr( $step['key'] ); ?>"
                       title="<?php echo esc_attr( $step['title'] ); ?> <?php printf( __( '(%1$s of %2$s)', 'phys-core' ), $position, $count_steps ); ?>"></a>
    ...
    <main>
		<?php
		do_action( 'phys_getting_started_main_content' );
		?>
    </main>
</div>
