...
<style id="phys-core-admin-styles">
    .tc-base-color {
    ...
    /* Import demo */
    .tc-importer-wrapper .phys-demo .status {
        background-color: <?php echo esc_attr( $base_color ); ?> !important;
    }

    .tc-importer-wrapper .phys-demo .status:hover {
        background-color: <?php echo esc_attr( $background_color ); ?> !important;
    }

    /* Mega menu */
    .phys-wrapper-mega-menu .field-phys-sub-align input:checked {
        color: <?php echo esc_attr( $base_color ); ?> !important;
    }
