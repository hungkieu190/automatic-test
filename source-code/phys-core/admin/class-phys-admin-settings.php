...
/**
 * Class Phys_Admin_Settings
 *
 * @since 1.1.0
 */
class Phys_Admin_Settings extends Phys_Singleton {
	/**
	 * @var string
	 *
	 * @since 1.1.0
	 */
	private static $key_option = 'phys_core_admin_settings';
	...
	/**
	 * Phys_Admin_Settings constructor.
	 *
	 * @since 1.1.0
	 */
