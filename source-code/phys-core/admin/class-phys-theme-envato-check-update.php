...
/**
 * Class Phys_Theme_Check_Update
 *
 * @since 1.1.0
 */
class Phys_Theme_Envato_Check_Update {
	/**
	 * Personal token by PhysCode.
	 *
	 * @since 1.1.0
	 *
	 * @var string
	...
	/**
	 * Phys_Theme_Check_Update constructor.
	 *
	 * @since 1.1.0
	 *
	...
	public function __construct( $item_id, $local_version ) {
		...
		$this->token         = Phys_Admin_Config::get( 'personal_token' );
	}
	...
	private function get_theme_data_remote() {
		$data = Phys_Envato_API::get_theme_metadata( $this->item_id, $this->token );
