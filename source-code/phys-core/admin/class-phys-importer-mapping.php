...
/**
 * Class Phys_Importer_Mapping
 *
 * @since 1.0.1
 */
class Phys_Importer_Mapping extends Phys_Singleton {
	/**
	 * @since 1.0.1
	 *
	 * @var null
	...
	public static function get_terms_mapping() {
		if ( self::$terms === null ) {
			...
			self::$terms    = $phys_wp_import->processed_terms;
		}
	...
	/**
	 * Phys_Importer_Mapping constructor.
	 *
	 * @since 1.0.1
	 */
	...
	private function mapping_content_so_builder( $value ) {
		...
		foreach ( $child_widgets as $i => $child_widget ) {
			$new_widget = Phys_Widget_Importer_Service::map_so_settings_widget( $child_widget );
