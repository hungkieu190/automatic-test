...
/**
 * Class Phys_Admin_Sub_Page
 *
 * @since 0.8.5
 */
abstract class Phys_Admin_Sub_Page extends Phys_Singleton {
	/**
	...
	public static function get_template( $template, $args = null ) {
		return Phys_Dashboard::get_template( $template, $args );
	}
	...
	protected function get_link_myself() {
		return Phys_Dashboard::get_link_page_by_slug( $this->key_page );
	}
	...
	/**
	 * Phys_Admin_Sub_Page constructor.
	 *
	 * @since 0.8.5
	 */
	protected function __construct() {
		if ( is_null( $this->key_page ) ) {
			wp_die( __( 'variable <strong>key_page</strong> must be over-ridden in a sub-class.', 'phys-core' ) );
		}
	...
	private function hooks() {
		add_action( "phys_dashboard_main_page_$this->key_page", array( $this, 'main_template' ) );
	}
