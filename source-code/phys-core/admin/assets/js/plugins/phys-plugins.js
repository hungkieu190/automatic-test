...
var Phys_Plugins = (function ($) {
    var ajax_url = phys_plugins_manager.admin_ajax_action;
...
var Phys_Plugins_Queue = (function ($) {
    var actions = [];
    ...
    function _run() {
        ...
        Phys_Plugins.request(first.action, first.slug)
